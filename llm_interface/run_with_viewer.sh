#!/bin/bash
# 使用mjpython运行端到端导航系统（macOS推荐方式）

echo "🎯 End-to-End Natural Language Navigation with 3D Viewer"
echo "============================================================"
echo ""
echo "This script runs the navigation system with MuJoCo 3D Viewer"
...
if ! command -v mjpython &> /dev/null; then
    ...
    echo "      python llm_interface/end_to_end_navigation.py"
    echo ""
    exit 1
fi
